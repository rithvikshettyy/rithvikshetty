      ...
      <section className="w-full mx-auto px-4 sm:px-8 md:px-20 lg:px-40 xl:px-64 2xl:px-80 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-row flex-wrap items-center justify-start gap-x-3 gap-y-4 w-full">
              {['Next.js', 'React', 'TypeScript', 'Node.js', 'Python', 'Machine Learning', 'Supabase', 'Tailwind CSS', 'Figma'].map((skill, i) => (
