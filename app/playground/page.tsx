  ...
  return (
    <div className="h-[300vh] bg-black text-white relative">
      ...
      <div className="fixed inset-0 flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Extreme Minimal Back Link */}
        <div className="fixed top-8 left-8 z-50 opacity-10 hover:opacity-100 transition-opacity">
            <Link href="/" className="p-4 rounded-full border border-white/10 bg-black/50 backdrop-blur-md">
            <ArrowLeft size={16} />
            </Link>
        </div>
