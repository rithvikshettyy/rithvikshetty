    ...
    <div className="bg-black text-white min-h-screen pt-32 pb-20">
      <div className="w-full mx-auto px-4 sm:px-8 md:px-20 lg:px-40 xl:px-64 2xl:px-80">
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-neutral-400 mt-4 md:mt-6 text-base md:text-lg max-w-2xl">
            A collection of recent projects showcasing my expertise in full-stack development, UI/UX design, and creative problem-solving.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-8 md:gap-y-20">
            ...
            >
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <span className="inline-block text-xs text-neutral-500 uppercase tracking-widest hover:text-white transition-colors">
                    View Project →
                  </span>
                </div>
              </motion.div>
