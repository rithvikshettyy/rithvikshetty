      ...
      {isLoaded && song && (
        ...
        >
          <div className="relative flex items-center justify-center shrink-0 w-6 h-6">
            <svg viewBox="0 0 24 24" className="w-full h-full text-[#1DB954] fill-current" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center gap-2 text-sm md:text-base font-medium tracking-tight overflow-hidden">
            ...
            <div className="flex items-center gap-1 overflow-hidden truncate">
              ...
              >
                <span className="text-neutral-900 dark:text-neutral-100 font-semibold truncate shrink">{song.track}</span>
                <span className="text-neutral-600 dark:text-neutral-700 shrink-0">·</span>
